...
public class FirstLevelDivisions {
     ...
     */
    public FirstLevelDivisions(int division_id, String division, Date create_date, String created_by, Timestamp last_update, String last_updated_by, int country_id) {
     ...
     */
    public FirstLevelDivisions(String division) { this.division = division; }
