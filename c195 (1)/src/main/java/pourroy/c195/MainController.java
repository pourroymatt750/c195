...
public class MainController {
    ...
    public void onDeleteCustomerBtn(ActionEvent actionEvent) throws SQLException {
        ...
        Alert alert = new Alert(Alert.AlertType.WARNING);
        alert.setTitle("WARNING");
        alert.setContentText("Are you sure you want to delete " + customerName + " ?");
        Optional<ButtonType> result = alert.showAndWait();
    ...
    public void onDeleteApptBtn(ActionEvent actionEvent) throws IOException, SQLException {
        ...
        try {
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("WARNING");
            alert.setContentText("Are you sure you want to delete " + appointmentName + " ?");
            Optional<ButtonType> result = alert.showAndWait();
            ...
            alert2.setContentText(appointmentName + " was deleted.");
