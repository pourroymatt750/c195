...
public class FirstLevelDivisionsDoa {
    ...
    public static ObservableList<FirstLevelDivisions> getAllDivisions() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                FirstLevelDivisions fld = new FirstLevelDivisions(Division, Division_ID, Country_ID);
    ...
    public static FirstLevelDivisions getDivisionId(String Division) {
        ...
        try {
            String sql = "SELECT Division_ID, Division, Country_ID FROM first_level_divisions WHERE Division = ?";
            ...
            while (rs.next()) {
                ...
                division = new FirstLevelDivisions(DivisionName, DivisionId, Country_ID);
            }
    ...
    public static ObservableList<FirstLevelDivisions> getCountryDivisions(int Country_ID) throws SQLException {
        ObservableList<FirstLevelDivisions> countryDivisionsList = FXCollections.observableArrayList();

        try {
            String sql = "SELECT Division, Division_ID, Country_ID FROM first_level_divisions WHERE Country_ID=?";
