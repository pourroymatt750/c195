...
public class ReportsController {
    ...
    public void initialize() throws SQLException {
        ...
        totalApptsTable.setItems(AppointmentDoa.getApptsByTypeAndMonth());
        appointment_type.setCellValueFactory(new PropertyValueFactory<>("type"));
        appointment_month.setCellValueFactory(new PropertyValueFactory<>("start"));
        total_appointments.setCellValueFactory(new PropertyValueFactory<>("appointment_id"));
    }
}
