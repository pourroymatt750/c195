...
public class Appointments {
     ...
     */
    public Appointments(int appointment_id, String title, String description, String appointment_location, String type, LocalDateTime start, LocalDateTime end, Date create_date, String created_by, Date last_update, String last_updated_by, int customer_id, int user_id, int contact_id) {
     ...
     * @param user_id is User ID
     */
    public Appointments(int appointment_id, String title, String description, String appointment_location, String contact_name, String type, LocalDateTime start, LocalDateTime end,int customer_id, int user_id) {
        this.appointment_id = appointment_id;
        this.title = title;
        this.description = description;
        this.appointment_location = appointment_location;
    ...
    public Appointments(LocalDateTime start, LocalDateTime end, int customer_id) {
        this.start = start;
        this.end = end;
        this.customer_id = customer_id;
    }

    public Appointments(int appointment_id, String title, String description, String type, LocalDateTime start, LocalDateTime end, int customer_id){
        this.appointment_id = appointment_id;
        this.title = title;
        this.description = description;
        this.type = type;
    ...
    public Appointments(String type, LocalDateTime start, int appointment_id) {
        this.type = type;
        this.start = start;
        this.appointment_id = appointment_id;
    }
