...
public class Appointments {
     ...
     */
    public Appointments(int appointment_id, String title, String description, String appointment_location, String type, Date start, Date end, Date create_date, String created_by, Date last_update, String last_updated_by, int customer_id, int user_id, int contact_id) {
